...
def J(): #matriz jacobiana
    J = np.array([[PQ("P",1,"a",1), PQ("P",1,"a",2), PQ("P",1,"a",3), PQ("P",1,"a",4), PQ("P",1,"a",5), PQ("P",1,"v",3), PQ("P",1,"v",4), PQ("P",1,"v",5)],
        [PQ("P",2,"a",1), PQ("P",2,"a",2), PQ("P",2,"a",3), PQ("P",2,"a",4), PQ("P",2,"a",5), PQ("P",2,"v",3), PQ("P",2,"v",4), PQ("P",2,"v",5)],
        [PQ("P",3,"a",1), PQ("P",3,"a",2), PQ("P",3,"a",3), PQ("P",3,"a",4), PQ("P",3,"a",5), PQ("P",3,"v",3), PQ("P",3,"v",4), PQ("P",3,"v",5)],
        [PQ("P",4,"a",1), PQ("P",4,"a",2), PQ("P",4,"a",3), PQ("P",4,"a",4), PQ("P",4,"a",5), PQ("P",4,"v",3), PQ("P",4,"v",4), PQ("P",4,"v",5)],
        [PQ("P",5,"a",1), PQ("P",5,"a",2), PQ("P",5,"a",3), PQ("P",5,"a",4), PQ("P",5,"a",5), PQ("P",5,"v",3), PQ("P",5,"v",4), PQ("P",5,"v",5)],
        [PQ("Q",3,"a",1), PQ("Q",3,"a",2), PQ("Q",3,"a",3), PQ("Q",3,"a",4), PQ("Q",3,"a",5), PQ("Q",3,"v",3), PQ("Q",3,"v",4), PQ("Q",3,"v",5)],
        [PQ("Q",4,"a",1), PQ("Q",4,"a",2), PQ("Q",4,"a",3), PQ("Q",4,"a",4), PQ("Q",4,"a",5), PQ("Q",4,"v",3), PQ("Q",4,"v",4), PQ("Q",4,"v",5)],
        [PQ("Q",5,"a",1), PQ("Q",5,"a",2), PQ("Q",5,"a",3), PQ("Q",5,"a",4), PQ("Q",5,"a",5), PQ("Q",5,"v",3), PQ("Q",5,"v",4), PQ("Q",5,"v",5)]
        ], dtype = float)
    return J
...
while i >= 0: #OTRAS ITERACIONES CON J0 FIJO
    i+=1
    Inc = np.dot(np.linalg.inv(J0), R(S)) + Inc #a2, a3, a4, a5, a6, v4, v5, v6 incógnitas #PARA DESHONESTO IRÍA J0 Y NO J()
    M =  np.array([1.05, 1.05, 1.07, Inc[5], Inc[6], Inc[7]])
    A =  np.array([0, Inc[0], Inc[1], Inc[2], Inc[3], Inc[4]])
    S = VaS(Y, M, A)
...
print("NEWTON RAPHSON DESHONESTO")
for i in range(6):
